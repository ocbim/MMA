...
const myImports = [BrowserModule, AppRoutingModule, HttpClientModule];
const myProviders = [AuthService, DataApiService, DateService];

@NgModule({
  declarations: [myDeclarations, UnderNavbarComponent],
  imports: [myImports],
